...
- fix Mac OS keyboard layout detection
- fix missing man page entry for pixel-depth, etc
- fix resource leaks on 64-bit MS Windows builds
- fix XSettings error preventing server from starting
- fix XSettings command line tool crash
- fix window rendering pixel depth ignored
...
- fix scroll encoding errors during window resizing
