...
class WindowModel(BaseWindowModel):
    ...
    def __init__(self, parking_window, client_window):
        ...
        self.property_names += ["title", "icon-title", "size-hints", "class-instance", "icon", "client-machine", "modal", "iconic", "decorations"]
        self.call_setup()
    ...
    def _handle_icon_title_change(self):
        ...
        log("_NET_WM_ICON_NAME=%s", icon_name)
