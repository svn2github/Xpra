...
- fix X11 display detection (socket may be owned by root with some display managers)
...
- don't overwrite the dynamic system tray icon with the default one on startup
